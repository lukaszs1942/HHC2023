...
First attempt was to try to decompile Java application how it's structured. During RE process using Java Decompiler. After swift code review we found interesting line:
